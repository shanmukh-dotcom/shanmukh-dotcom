...
def build_web():
    ...
    for i, (skill, color) in enumerate(skills):
        ...
        skills_html += f'''
                        <div class="skill-pill" style="--delay: {i * 0.05}s">
...
<body>
    ...
    <div class="banner-container" id="main-content">
        ...
        <div class="glass-panel" id="glass-panel">
            ...
            <div class="right-panel">
                ...
                <div class="content-wrapper">
                    <p class="greeting reveal-item" style="--delay: 0s">Hi there 👋</p>
                    <h1 class="name reveal-item slide-up" style="--delay: 0.2s">I'm <span class="gradient-text">Shanmukh</span></h1>
                    
                    <div class="terminal-typing reveal-item" style="--delay: 0.4s" id="terminal-box">
                    ...
                    <div class="info-grid">
                        <div class="info-row reveal-item slide-up" style="--delay: 0.6s">
                        ...
                        <div class="info-row reveal-item slide-up" style="--delay: 0.72s">
                            <span class="info-label">
                        ...
                        <div class="info-row reveal-item slide-up" style="--delay: 0.84s">
                            <span class="info-label">
                        ...
                        <div class="info-row reveal-item slide-up" style="--delay: 0.96s">
                            <span class="info-label">
                        ...
                        <div class="info-row reveal-item slide-up" style="--delay: 1.08s">
                            <span class="info-label">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
                                Portfolio
                            </span>
                            <span class="info-val highlight">github.com/shanmukh-dotcom/prof-portfollio-</span>
                        </div>
                        <div class="info-row reveal-item slide-up" style="--delay: 1.20s">
                            <span class="info-label">
                            ...
                            <span class="info-val">chennuboinashanmukh2007@gmail.com</span>
                        </div>
                    </div>

                    <div class="skills-heading reveal-item" style="--delay: 1.3s">Skills &amp; Technologies</div>
        ...
        <div class="socials">
            <a href="https://github.com/shanmukh-dotcom" target="_blank" class="social-link reveal-item slide-up" style="color: #8B5CF6; --delay: 1.5s">
            ...
            <a href="https://www.linkedin.com/in/shanmukha-chennuboina-7a61073a9/" target="_blank" class="social-link reveal-item slide-up" style="color: #22D3EE; --delay: 1.6s">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                <span class="social-text">LinkedIn</span>
            </a>
            <a href="https://github.com/shanmukh-dotcom/prof-portfollio-" target="_blank" class="social-link reveal-item slide-up" style="color: #7C3AED; --delay: 1.7s">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
                <span class="social-text">Portfolio</span>
            </a>
            <a href="mailto:chennuboinashanmukh2007@gmail.com" target="_blank" class="social-link reveal-item slide-up" style="color: #22D3EE; --delay: 1.8s">
    ...
    print("index.html and script.js successfully updated")
